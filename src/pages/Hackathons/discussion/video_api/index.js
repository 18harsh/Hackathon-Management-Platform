...
//     useEffect( () => {
//         setMeetingIdValue(props.meetingId);
//         toGetToken();
//     },[toGetToken])
//
//     async function toGetToken() {
//         const tokenValueCheck = await getToken();
//         const valid = await validateMeeting( "jURdxvVdgov6UL9KIUKQ" );
//         console.log(tokenValue,valid)
//         if (valid) {
//             // setReadyToJoin(true);
//             setTokenValue(tokenValueCheck);
//             setMeetingIdValue("jURdxvVdgov6UL9KIUKQ");
//             setWebcamOn(true);
//             setMicOn(true);
//             setLoading(false)
//         } else {
//             const _meetingId = await createMeeting( "jURdxvVdgov6UL9KIUKQ");
//             console.log(_meetingId);
//             setTokenValue(tokenValueCheck);
//             setMeetingIdValue(_meetingId);
//             // setReadyToJoin(true);
//             setWebcamOn(true);
//             setMicOn(true);
//             setLoading(false);
...
export default VideoSdkComponent;
